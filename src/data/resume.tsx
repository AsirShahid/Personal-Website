...
export const DATA = {
  ...
  description:
    "Medical student on the radiology track of the three-year MD program at Stony Brook's Renaissance School of Medicine. Formerly a Data Scientist at Goldman Sachs and an Automation Engineer at Zebra Technologies.",
  summary:
    "I'm a medical student on the radiology track of the [Three-Year MD program](https://renaissance.stonybrookmedicine.edu/Three-Year-MD) at Stony Brook University's [Renaissance School of Medicine](https://renaissance.stonybrookmedicine.edu/) (MD Class of 2029). Before medicine, I earned a BS in [Applied Mathematics and Statistics](https://www.stonybrook.edu/commcms/ams/) at Stony Brook, then worked as an Automation Engineer at Zebra Technologies and a Data Scientist at Goldman Sachs. Wanting to work directly with patients, I moved into healthcare, volunteering as an [EMT with Port Jefferson EMS](https://pjems.org) and working as a medical assistant while conducting [computational biochemistry research in the Nagan Lab](https://sites.google.com/view/mnagan). These days my interests sit at the computational end of imaging: reconstruction, quantitative methods, and better tools for radiology.",
  avatarUrl: "",
